...
if(FactorSettings==TRUE){
  ...
  options(stringsAsFactors = FALSE)}else{
    OriginalSettings<-"FALSE"
    options(stringsAsFactors = FALSE)} # shouldnt need this else part, but just to make sure.
...
Table.Hexcodes<-data.frame(
  Colour=c("Maroon","Assessor","red","orange","green","greenLS","greenHS","blue","Stage1","Stage2","Stage3","Stage4","Stage5","Cohort1","Cohort2","Cohort3","Cohort4","Cohort5","Cohort6","athenayellow","athenagrey","athenateal","turdly"),
  Hexcode=c("#800000","#88CCEE","#D92120","#E68B33","#86BB6A","#B1BE4E","#6DB388","#3D52A1","#AA4455","#AA7744", "#AAAA44", "#44AA77", "#4477AA","#AA4455","#AA7744","#AAAA44", "#44AA77","#44AAAA", "#4477AA","#F9CA80","#809BB2","#B2E1E9","##bea474"),
  Description=c("Maroon","Light blue","U-Red","B-Orange","S-Mid-Green","LS-Orange-Green","HS-Blue-Green","E-Blue","Series Red","Series Orange", "Series Orange-Green", "Series Dark-Green", "Series Light-Blue","Series Pinky-Red","Series Muted-Orange","Series-Yellowy-Green", "Series-Blue-Green","Series-Greeny-Blue", "Series-Grey-Blue","Athena SWAN Yellow","Athena SWAN Grey","Athena SWAN Teal","AI Turdly"))
...
if(OriginalSettings=="TRUE"){options(stringsAsFactors = TRUE)}
